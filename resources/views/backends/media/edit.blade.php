			...
			<div class="row">
				<div class="col-md-9 content">
					...
					<div id="frm-url" class="form-group">
						...
						<input type="text" name="title" class="form-control" class="frm-input" value="<?php echo url('/uploads').'/'.$media->path;?>" readonly>
					</div>
				...
				<div class="col-md-9">
					<div class="group-action">
						<a href="{{ route('deleteMediaAdmin',['id'=>$media->id]) }}" class="btn btn-delete btn-danger float-left">{{ __('Delete') }}</a>
