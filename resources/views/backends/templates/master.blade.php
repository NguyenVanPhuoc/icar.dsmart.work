...
<html>
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="{{ asset('plus/css/pnotify.custom.min.css') }}">
      <link rel="stylesheet" href="{{ asset('backends/css/custom_field.css')}}">
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
      ...
      <script src="{{ asset('plus/js/jquery.scrollbar.js')}}"></script>
      ...
      <script src="{{ asset('backends/js/menu.js')}}"></script>
      <script src="{{ asset('backends/js/pluss.js')}}"></script>
      <script src="{{ asset('backends/js/slug.js')}}"></script>
      <script src="{{ asset('backends/js/custom_field.js')}}"></script>
      <script src="{{ asset('plus/js/form_validate.js')}}"></script>
      <script src="{{ asset('plus/dropzone/dist/dropzone.js')}}"></script>
      <script src="{{ asset('plus/js/popup_media.js')}}"></script>
      <script type="text/javascript" src="{{ asset('plus/js/pnotify.custom.min.js') }}"></script>
   </body>
