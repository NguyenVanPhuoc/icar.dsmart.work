    ...
    <section class="content">
        <div class="container">
            <div class="head">
                ...
                <h1 class="title">{{__('Edit blog')}}</h1>
            </div>
            <div class="main">
                    ...
                    <div class="row">
                        <div class="col-md-9 content">
                            <div id="frm-title" class="form-group">
                                ...
                                <input type="text" name="title" value="{{$blog->title}}" class="form-control" data-error="{{ __('Enter title')}}" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div id="frm-content" class="form-group">
                                <label for="content" class="control-label">{{ __('Content') }}</label>
                                <textarea name="content" rows="10"  class="form-control editor">{!!$blog->content!!}</textarea>
                            </div>
                            <div id="frm-metaKey" class="form-group">
                                <label for="metaKey">{{ __('SEO key') }}</label>
                                <input name="metaKey" type="text" class="form-control" value="{{$blog->meta_key}}">
                            </div>
                            <div id="frm-metaValue" class="form-group">
                                <label for="metaValue" class="control-label">{{ _('SEO content') }}</label>
                                <textarea name="metaValue" rows="10"  class="form-control">{!!$blog->meta_value!!}</textarea>
                            </div>
