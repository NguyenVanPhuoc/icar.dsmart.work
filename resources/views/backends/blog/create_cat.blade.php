    ...
    <section class="content">
        <div class="container">
            <div class="head">
                ...
                <h1 class="title">{{__('New blog category')}}</h1>
            </div>
            <div class="main">
                @include('notices.index')
                <form action="{{ route('createBlogCatAdmin') }}" name="createBlogCat" class="dev-form" method="POST" data-toggle="validator" role="form">
                    @csrf
                    <div class="row">
